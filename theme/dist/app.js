...
/* harmony import */ var _js_animations__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/animations */ "./src/js/animations/index.js");
/* harmony import */ var _js_sliders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/sliders */ "./src/js/sliders/index.js");


document.addEventListener('DOMContentLoaded', function () {
  var animations = new _js_animations__WEBPACK_IMPORTED_MODULE_0__["default"]();
  console.log(animations); // eslint-disable-next-line no-unused-vars

  var sliders = new _js_sliders__WEBPACK_IMPORTED_MODULE_1__["default"]();
});
...
/* harmony export */ });
/* harmony import */ var _navigation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./navigation */ "./src/js/animations/navigation.js");
...
var Animations = /*#__PURE__*/function () {
  function Animations() {
    ...
    this.navigation = new _navigation__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this.menuIcon();
  }
  ...
  _createClass(Animations, [{
    ...
    value: function menuIcon() {
      ...
      document.querySelector('.menu-icon a').addEventListener('mouseenter', function () {
        _this.navigation.menuIconHoverIn();
      });
      document.querySelector('.menu-icon a').addEventListener('mouseleave', function () {
        _this.navigation.menuIconHoverOut();
      });
      document.querySelector('.menu-icon a').addEventListener('click', function () {
        _this.navigation.menuClick();
      });
    }
  }]);
...
/***/ "./src/js/animations/navigation.js":
/*!*****************************************!*\
  !*** ./src/js/animations/navigation.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Navigation = /*#__PURE__*/function () {
  function Navigation() {
    ...
    this.isOpened = false;
    this.icon = document.querySelector('nav'); // Timeline

    this.tl = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline();
    this.hoverTL = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline();
  }

  _createClass(Navigation, [{
    key: "menuIconHoverIn",
    value: function menuIconHoverIn() {
      if (!this.hoverTL.reversed()) {
        this.hoverTL.to(this.menuIconSVG.start, {
          duration: 0.3,
          translateX: '20%',
          ease: 'power4.easeInOut'
        });
        this.hoverTL.to(this.menuIconSVG.middle, {
          duration: 0.3,
          translateX: '-20%',
          ease: 'power4.easeInOut'
        }, '-=.3');
        this.hoverTL.to(this.menuIconSVG.end, {
          duration: 0.3,
          translateX: '20%',
          ease: 'power4.easeInOut'
        }, '-=.3');
    ...
    key: "menuIconHoverOut",
    value: function menuIconHoverOut() {
...
var HomeSlider = /*#__PURE__*/function () {
  ...
  _createClass(HomeSlider, [{
    ...
    value: function setSlideIndex(index) {
      document.querySelector('.our-works .slide-counter').innerHTML = "0".concat(index);
      document.querySelector('.works-slider .current-slide').innerHTML = "0".concat(index);
      document.querySelector('.works-slider .slide-progress b span').style.width = "".concat(index / this.numOfSlides * 100, "%");
    }
  }, {
    key: "setTotalSlides",
    value: function setTotalSlides(count) {
      this.numOfSlides = count;
      document.querySelector('.our-works .count').innerHTML = "0".concat(count);
      document.querySelector('.works-slider .slide-progress b span').style.width = "".concat((this.swiper.realIndex + 1) / this.numOfSlides * 100, "%");
    }
  }]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ServicesSlider)
/* harmony export */ });
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "./node_modules/swiper/swiper.esm.js");
/* harmony import */ var swiper_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper/css */ "./node_modules/swiper/swiper.min.css");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ServicesSlider = /*#__PURE__*/function () {
  function ServicesSlider() {
    ...
    var numOfSlides = [];
    this.swiper = [];
    this.swiper[0] = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider-1', {
      // configure Swiper to use modules
      loop: true,
      on: {
        beforeInit: function beforeInit() {
    ...
    this.swiper[0].on('slideChange', function () {
      _this.setSlideIndex(0, _this.swiper[0].realIndex + 1);
    });
    this.numOfSlides = [];
    this.setTotalSlides(0, numOfSlides[0]); // Second Slider

    this.swiper[1] = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider-2', {
      // configure Swiper to use modules
      loop: true,
      on: {
        beforeInit: function beforeInit() {
    ...
    this.swiper[1].on('slideChange', function () {
      _this.setSlideIndex(1, _this.swiper[1].realIndex + 1);
    });
    this.setTotalSlides(1, numOfSlides[1]); // Third Slider

    this.swiper[2] = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider-3', {
      // configure Swiper to use modules
      loop: true,
      on: {
        beforeInit: function beforeInit() {
    ...
    this.swiper[2].on('slideChange', function () {
      _this.setSlideIndex(2, _this.swiper[2].realIndex + 1);
    });
    this.setTotalSlides(2, numOfSlides[2]); // Fourth Slider

    this.swiper[3] = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider-4', {
      // configure Swiper to use modules
      loop: true,
      on: {
        beforeInit: function beforeInit() {
    ...
    this.swiper[3].on('slideChange', function () {
      _this.setSlideIndex(3, _this.swiper[3].realIndex + 1);
    });
  ...
  _createClass(ServicesSlider, [{
    key: "slideNext",
    value: function slideNext(slider) {
      this.swiper[slider].slideNext();
      this.setSlideIndex(slider, this.swiper[slider].realIndex + 1);
    }
  }, {
    key: "setSlideIndex",
    value: function setSlideIndex(slider, index) {
      var elem = ".slider-".concat(slider + 1);
      document.querySelector(elem).parentElement.childNodes[1].innerHTML = "0".concat(index);
      document.querySelector(elem).parentElement.childNodes[9].childNodes[1].childNodes[1].innerHTML = "0".concat(index);
      document.querySelector(elem).parentElement.childNodes[9].childNodes[1].childNodes[3].childNodes[1].style.width = "".concat(index / this.numOfSlides[slider] * 100, "%");
    }
  }, {
    key: "setTotalSlides",
    value: function setTotalSlides(slider, count) {
      this.numOfSlides[slider] = count;
      var elem = ".slider-".concat(slider + 1);
      document.querySelector(elem).parentElement.childNodes[9].childNodes[1].childNodes[5].innerHTML = "0".concat(count);
      document.querySelector(elem).parentElement.childNodes[9].childNodes[1].childNodes[3].childNodes[1].style.width = "".concat((this.swiper[slider].realIndex + 1) / this.numOfSlides[slider] * 100, "%");
    }
  }]);
...
/******/ 	__webpack_require__.O(undefined, ["app"], () => (__webpack_require__("./src/index.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["app"], () => (__webpack_require__("./src/scss/index.scss")))
